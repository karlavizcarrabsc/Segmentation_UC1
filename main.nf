...
process compute_metrics {
    ...
    python3 /app/compute_metrics.py -i $input_file -c $challenges_ids -e $event_id -g $goldstandard_dir -p $participant_id -com $community_id -o `pwd`/"${default_assessment_filename}"
